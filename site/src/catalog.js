...
export const components = Object.freeze([
  ...
  component(11, "chat", "Chat", "Composites", "A virtualized controlled conversation with tail-follow and unread behavior.", "chat", "Chat", 'Chat::new("conversation", prompt, window, cx)', "tall"),
  ...
  component(13, "context-meter", "Context meter", "Progress", "Context-window usage as a ring, bar, or text with severity tones and a breakdown.", "context_meter", "ContextMeter", 'ContextMeter::new("context", &usage)'),
  component(14, "command-search", "Command search", "Navigation", "Keyboard-first command discovery backed by stable application IDs.", "command_search", "CommandSearch", 'CommandSearch::new("commands", window, cx)', "tall"),
  component(15, "sidebar-nav", "Sidebar navigation", "Navigation", "Filterable, accessible navigation for growing AI workspaces.", "sidebar_nav", "SidebarNav", 'SidebarNav::new("workspace-nav", window, cx)', "tall"),
  component(16, "thread-list", "Thread list", "Navigation", "A grouped conversation list with search, archived threads, and typed row actions.", "thread_list", "ThreadList", 'ThreadList::new("threads", window, cx)', "tall"),
  component(17, "fine-tune", "Fine-tune card", "Composites", "A controlled property inspector for precise model and design settings.", "fine_tune", "FineTuneCard", 'FineTuneCard::new("controls", values, typefaces, window, cx)', "tall"),
  component(18, "records-table", "Records table", "Data tables", "A controlled virtualized records grid for large, changing datasets.", "records_table", "RecordsTable", 'RecordsTable::new("accounts", "Accounts", window, cx)'),
  component(19, "diff-table", "Diff table", "Data tables", "A virtualized before-and-after proposal grid with explicit change state.", "diff_table", "DiffTable", 'DiffTable::new("proposal", "Proposed changes", window, cx)'),
  component(20, "filter-table", "Filter table", "Data tables", "A controlled task grid with typed filters and stable-row reorder motion.", "filter_table", "FilterTable", 'FilterTable::new("tasks", "Tasks", window, cx)'),
  component(21, "comparison-table", "Comparison table", "Data tables", "A bounded feature matrix with semantic values and sticky context.", "comparison_table", "ComparisonTable", 'ComparisonTable::new("plans", "Plans", window, cx)'),
  component(22, "code-block", "Code block", "Readable output", "Selectable code with language context and progressive reveal.", "code_block", "CodeBlock", 'CodeBlock::new("patch", source).language("rust")'),
  component(23, "approval", "Approval card", "Decisions", "An explicit, keyboard-operable human gate for consequential agent actions.", "approval", "ApprovalCard", 'ApprovalCard::new("deploy", "Deploy production?")', "tall"),
  component(24, "recommendation", "Recommendation card", "Decisions", "A focused recommendation with rationale and typed actions.", "recommendation", "RecommendationCard", 'RecommendationCard::new("next-step", "Ship the fix")', "tall"),
  component(25, "context", "Context cards", "Evidence", "Compact source context that preserves provenance and readable detail.", "context_card", "ContextCard", 'ContextCard::new("design-doc", "Architecture")', "tall"),
  component(26, "insights", "Insight card", "Evidence", "Paged analytical findings with chart-ready, semantic values.", "insight", "InsightCard", 'InsightCard::new("retention", "Retention improved")'),
  component(27, "prompt-bar", "Prompt bar", "Composites", "A hybrid-controlled composer with mentions, commands, models, and attachments.", "prompt_bar", "PromptBar", 'PromptBar::new("agent-prompt", window, cx)'),
  component(28, "selection-actions", "Selection actions", "Readable output", "Ask, explain, and rewrite actions anchored to selected Markdown.", "selection_actions", "SelectionActions", 'SelectionActions::new("answer-actions", markdown, window, cx)'),
]);
