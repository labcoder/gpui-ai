...
const EXCEPTIONS: &[Exception] = &[
    ...
    Exception {
        ...
        category: Category::ScrollDelta,
        rationale: "the jump drive's arrival threshold over remaining scroll distance",
    },
    Exception {
        file: "chat.rs",
        expression: "gpui::px(2.)",
        context: "let tolerance",
        category: Category::ScrollDelta,
        rationale: "readback classification tolerance: wider than paint rounding, narrower than any step",
    },
    Exception {
        file: "chat.rs",
        expression: "gpui::px(2.)",
        context: "let step",
        category: Category::ScrollDelta,
        rationale: "the drive's minimum step, so convergence cannot stall below paint rounding",
    },
    Exception {
