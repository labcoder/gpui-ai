    ...
    pub const fn meta(self) -> Option<StoryMeta> {
        Some(match self {
            ...
            Self::Chat => StoryMeta {
                ...
                lineage_note: "A virtualized, controlled transcript: unread reconciliation, jump to latest, and an anchor that survives messages arriving off screen.",
            ...
            Self::Attachments => StoryMeta {
                ...
                lineage: Lineage::New,
                lineage_basis: "",
                lineage_note: "Files on their way into a prompt, with upload progress and failure shown per item.",
